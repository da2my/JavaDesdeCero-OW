...
public class K_FechasFijas {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Dias en la clase MonthYear %s: %d%n", anioYMesActual, anioYMesActual.lengthOfMonth());
		YearMonth caducidadTarjetaCredito = YearMonth.of(2018, Month.FEBRUARY);
		System.out.printf("Su tarjeta de credito caduca en %s ", caducidadTarjetaCredito);
